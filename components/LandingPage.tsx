    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button
                ...
                className="px-8 py-4 bg-gradient-to-r from-blue-600 to-green-600 text-white text-lg font-semibold rounded-xl hover:from-blue-500 hover:to-green-500 transition-all shadow-lg shadow-blue-500/50 transform hover:scale-105"
              >
                Get Started Free
              </button>
              <button
                onClick={() => document.getElementById('features')?.scrollIntoView({ behavior: 'smooth' })}
                className="px-8 py-4 bg-gray-800 border border-gray-600 text-white text-lg font-semibold rounded-xl hover:bg-gray-700 transition-all"
              >
                Explore Features
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-400">Veo Models</div>
            </div>
            <div className="text-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-gray-800/50 border border-gray-700 rounded-2xl p-8 hover:border-blue-500 transition-all">
          ...
          <div className="bg-gray-800/50 border border-gray-700 rounded-2xl p-8 hover:border-green-500 transition-all">
            <div className="text-4xl mb-4">💼</div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="bg-gradient-to-r from-blue-600 to-green-600 rounded-3xl p-12 text-center">
          ...
          <button
            onClick={onGetStarted}
            className="px-10 py-5 bg-white text-blue-600 text-lg font-bold rounded-xl hover:bg-gray-100 transition-all shadow-2xl transform hover:scale-105"
          >
...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description, highlight }) => {
  return (
    <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-6 hover:border-blue-500 transition-all hover:transform hover:scale-105">
      <div className="text-4xl mb-3">{icon}</div>
      <div className="flex items-center gap-2 mb-2">
        <h3 className="text-xl font-bold">{title}</h3>
        {highlight && (
          <span className="text-xs px-2 py-1 bg-blue-600 rounded-full">{highlight}</span>
        )}
      </div>
